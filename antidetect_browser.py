...
#       GET {PROXY_API_BASE_URL}/{start}-{end}?format=txt
#   e.g. https://nodejsclusters-213001-0.cloudclusters.net/api/external/proxies/1-50?format=txt
...
PROXY_API_BASE_URL = 'https://nodejsclusters-213001-0.cloudclusters.net/api/external/proxies'
...
def _build_proxy_api_url(
    ...
    RANGE MODE (preferred, proxy_range != None):
        {base_url}/{start}-{end}
        e.g. https://nodejsclusters-213001-0.cloudclusters.net/api/external/proxies/1-50
...
def load_proxies_from_api(
    ...
    1. RANGE MODE (default, proxy_range=(1, 50)):
       GET {api_url}/{start}-{end}?format=txt
       e.g. https://nodejsclusters-213001-0.cloudclusters.net/api/external/proxies/1-50?format=txt
